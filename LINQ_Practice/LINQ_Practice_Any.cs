...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Any
    {
        ...
        {
            var doAny = PracticeData.Any(o => o.PrimaryInstructor.Active);
            Assert.IsTrue(doAny); //<-- change false to doAny
        }
        ...
        {
            var doAny = PracticeData.Any(o => o.JuniorInstructors.Count == 3);
            Assert.IsTrue(doAny); //<-- change false to doAny
        }
        ...
        {
            var doAny = PracticeData[2].Students.Any(o => o.Active == false && o.Birthday.Month.Equals("October"));  //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var doAny = PracticeData[3].JuniorInstructors.Any(o => o.Active ==false);  
            //HINT: Cohort4 is PracticeData[3]
            Assert.IsFalse(doAny); //<-- change true to doAny
        }
    }
}
