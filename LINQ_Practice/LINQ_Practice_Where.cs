...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(o => o.Active ==true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(o => o.FullTime).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(o => o.PrimaryInstructor.FirstName.Equals("Jurnell")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(o => o.JuniorInstructors.Count == 3).ToList();
