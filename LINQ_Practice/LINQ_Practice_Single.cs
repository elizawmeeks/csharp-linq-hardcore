...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(o => o.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.Single(o => o.FullTime == true && o.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(o => o.PrimaryInstructor.FirstName == "Zelda");
        ...
        {
            var shouldThrowException = PracticeData.Single(o => o.Active == false && o.FullTime == false);
        }
        ...
        {
            var shouldThrowException = PracticeData.Single(o => o.JuniorInstructors.Count == 2);
        }
    }
}
