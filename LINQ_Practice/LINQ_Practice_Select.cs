...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(o => o.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(o => o.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(o => o.PrimaryInstructor.FirstName).ToList();
        ...
        {
            var expected = PracticeData.Select(o => o.Name).ToList();
