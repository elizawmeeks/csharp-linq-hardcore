...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(o => (o.PrimaryInstructor.FirstName.Equals("Zachary") && o.PrimaryInstructor.LastName.Equals("Zohan")) || (o.JuniorInstructors.Any(e => e.FirstName =="Zachary" && e.LastName == "Zohan"))).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(o => o.FullTime == false  && o.PrimaryInstructor.Active == true && o.JuniorInstructors.All(e => e.Active == true)).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(o => o.PrimaryInstructor.FirstName == "Kate" || o.Students.Any(e => e.FirstName == "Kate") || o.JuniorInstructors.Any(b => b.FirstName == "Kate")).ToList();
        ...
        {
            var student = PracticeData.SelectMany(c => c.Students).OrderBy(o => o.Birthday).First();
        ...
        {
            var student = PracticeData.SelectMany(o => o.Students).OrderByDescending(s => s.Birthday).First();
        ...
        {
            var ActualStudents = PracticeData.SelectMany(c => c.Students).Where(s =>s.Active == false).OrderBy(k => k.LastName).ToList();
