...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(o => o.JuniorInstructors.Count >= 2);
        ...
        {
            var doAll = PracticeData.All(o => o.Students.Count == 5);
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(o => o.PrimaryInstructor.Birthday.Year <= 1980 && o.PrimaryInstructor.Birthday.Year > 1990);
        ...
        {
            var doAll = PracticeData.All(o => o.PrimaryInstructor.Active);
        ...
        {
            var doAll = PracticeData[0].Students.All(o => o.FirstName.Contains("e"));
        ...
        {
            var doAll = PracticeData.All(c => c.PrimaryInstructor.FirstName.Contains("a"));
